...
///
/// The request has already been matched by `tool_name`, so the serialized
/// payload preserves that same name for hook logs and for consumers that pair
/// pre/post events across processes.
